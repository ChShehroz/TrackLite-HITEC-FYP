  ...
  return (
    <div className="relative text-center">
      ...
      <div className="absolute top-[60px] left-[55%]">
        <div className="w-[450px] h-[450px] pt-1.5 border-[#DEC0A7] bg-gradient-to-r from-[#ffe572] to-[#ffe57275] shadow-lg bg-white rounded-xl">
          <div className="w-[450px] h-[450px] px-8 py-8 bg-gradient-to-b from-[#f5f1e1] via-[#fffdf6] bg-[#fffdf6] rounded-t-md rounded-b-xl ">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-3">
                <label
                  className="block text-gray-700 text-sm text-left font-medium ml-4 mb-2"
                  htmlFor="email"
                >
                  Email
                </label>
                <input
                  ...
                  className="w-full px-3 py-1.5 bg-transparent border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#E3C3A9]"
                />
              </div>
